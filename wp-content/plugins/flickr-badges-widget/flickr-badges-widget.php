...
class Flickr_Badges_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array('classname' => 'widget_flickr','display'=>'inline-block','width'=>500,'height'=>300, 'description' => __( '[+] Displays a Flickr photo stream from an ID', $this->textdomain ) );
